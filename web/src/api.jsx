...
export const DOC = {
  ...
  score: ['타점 점수 계산식',
    <>
      <p>두 축으로 봅니다. <b>품질은 이 상품이 꾸준한가, 타점은 지금 얼마나 싸게 사는가</b>입니다.</p>
      <p><code>배당률 30 · 가격 위치 20 · 분배금 성장 15 · 위험조정 수익 15 · 환율 10 · 배당락 회복력 10</code></p>
      <p>종합은 <b>품질 75% + 타점 25%</b>입니다. 85 이상 적극매수, 70~84 매수, 55~69 분할·관망, 55 미만 보류.</p>
      <p>타점 비중이 낮은 데는 이유가 있습니다. 과거 10년으로 검증해 보니
        <b>가격으로 매수 시점을 맞히는 힘이 거의 없었습니다.</b> 방향이 맞은 것은 고점 대비 낙폭
        하나뿐이었고, 200일선 추세와 골든크로스는 오히려 반대로 작동해 점수에서 뺐습니다(경고로만 남김).</p>
      <p>가격 위치는 <b>절대 낙폭과 그 종목의 자기 이력</b>을 함께 봅니다. 같은 -10%라도 평소 -50%씩
        빠지던 종목에겐 평범하고, -14%가 최대였던 종목에겐 큰 사건이기 때문입니다.</p>
